...
| [**微博个人主页历史导出器**](weibo-profile-exporter.user.js) | 按日期/类型抓取历史并打包成离线归档 ZIP | 页面左下角蓝色按钮「导出历史」 |

> 均由 @UIM258 开发并维护，欢迎使用与二次开发。
...
4. 也可在 GreasyFork 搜索同名脚本一键安装

**重要**：微博对未登录访问信息流会风控，两个脚本都需要登录态才能正常工作。
